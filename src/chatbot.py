...
st.set_page_config(page_title="Intelligent Video and Audio Q&A with LLMs", page_icon=":robot:")

Falcon_endpoint_name = "<REPLACE_WITH_ENDPOINT_NAME>"
embedding_endpoint_name = "<REPLACE_WITH_ENDPOINT_NAME>"
...
with left_column:
    st.header("Intelligent Video and Audio Q&A with LLMs")
